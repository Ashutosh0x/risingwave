...
| enable_project_openai_embedding_detail_log | Enables detailed `ProjectExecutor` logs for projections containing `openai_embedding`. This is intended for troubleshooting chunk-level concurrent projection execution and may produce a large amount of log output. | false |
